...
{ idx: 39, name: is_cpu_intel }
{ idx: 40, name: is_cpu_amd }
{ idx: 41, name: is_cpu_qualcomm }
{ idx: 42, name: is_cpu_apple }
{ idx: 43, name: is_ddr4 }
{ idx: 44, name: is_ddr5 }
{ idx: 45, name: is_gpu_nvidia }
{ idx: 46, name: is_gpu_amd }
{ idx: 47, name: has_external_gpu }
{ idx: 48, name: has_integrated_gpu }
{ idx: 49, name: is_light }
{ idx: 50, name: is_high_performance }
{ idx: 51, name: has_hdmi }
{ idx: 52, name: has_thunderbolt3 }
{ idx: 53, name: has_thunderbolt4 }
{ idx: 54, name: has_usb_pd }
{ idx: 55, name: has_dp_alt }
{ idx: 56, name: has_sd_card }
{ idx: 57, name: has_high_refreshrate }
{ idx: 58, name: ram_size }
{ idx: 59, name: battery_size }
{ idx: 60, name: screen_size }
{ idx: 61, name: screen_brightness }
{ idx: 62, name: num_usb_c }
{ idx: 63, name: num_usb_a }
{ idx: 64, name: weight }
{ idx: 65, name: screen_resolution }
{ idx: 66, name: storage_size }
{ idx: 67, name: price }
